...
from silicoflow.libmetaflow.util import url_quote, url_unquote
from silicoflow.libmetaflow.multicore_utils import parallel_map
from silicoflow.libmetaflow.datastore.util.s3util import aws_retry
...
def worker(queue, mode):
    try:
        from silicoflow.libmetaflow.libmetaflow_config import get_authenticated_boto3_client

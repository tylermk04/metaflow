...
from .. import libmetaflow_config
...
class MetaflowDataStore(object):
    ...
    def get_datastore_root_from_config(cls, echo, create_on_absent=True):
        """
        Returns a default choice for datastore_root from silicoflow.libmetaflow_config
        depending on the datastore type.
        """
        return getattr(libmetaflow_config,
    ...
    def __init__(self,
        ...
        if mode == 'w':
            ...
            if data_obj is None:
                ...
                for i in range(0, libmetaflow_config.MAX_ATTEMPTS):

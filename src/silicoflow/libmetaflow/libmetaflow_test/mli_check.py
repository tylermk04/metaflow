...
class MliCheck(MetaflowCheck):
    ...
    def __init__(self, flow):
        from silicoflow.libmetaflow.client import Flow, get_namespace
        self.flow = flow
    ...
    def _test_namespace(self):
        from silicoflow.libmetaflow.client import Flow,\
                                    get_namespace,\
                                    namespace,\
                                    default_namespace
        from silicoflow.libmetaflow.exception import MetaflowNamespaceMismatch
        import os

...
from silicoflow.libmetaflow.exception import MetaflowInternalError
from silicoflow.libmetaflow.util import get_username, resolve_identity
...
class MetadataProvider(object):
    ...
    def _tags(self):
        ...
        if env['libmetaflow_version']:
            tags.append('libmetaflow_version:' + env['libmetaflow_version'])
        return tags

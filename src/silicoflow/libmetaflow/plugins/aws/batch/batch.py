...
from silicoflow.libmetaflow.exception import MetaflowException, MetaflowInternalError
from silicoflow.libmetaflow.libmetaflow_config import BATCH_METADATA_SERVICE_URL, DATATOOLS_S3ROOT, \
...
class Batch(object):
    ...
    def launch_job(
        ...
        job_name = self._job_name(
            attrs['libmetaflow.user'],
            attrs['libmetaflow.flow_name'],
            attrs['libmetaflow.run_id'],
            attrs['libmetaflow.step_name'],
            attrs['libmetaflow.task_id'],
            attrs['libmetaflow.retry_count'],
        )
        if queue is None:
        ...
        job \
            ...
            .environment_variable('METAFLOW_USER', attrs['libmetaflow.user']) \

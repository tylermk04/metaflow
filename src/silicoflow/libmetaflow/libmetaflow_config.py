...
def init_config():
    ...
    home = os.environ.get('METAFLOW_HOME', '~/.libmetaflowconfig')
...
DATASTORE_LOCAL_DIR = '.libmetaflow'
...
CLIENT_CACHE_PATH = from_conf('METAFLOW_CLIENT_CACHE_PATH', '/tmp/libmetaflow_client')
...
###
# Boolean flag for libmetaflow AWS sandbox access
...
# PINNED_CONDA_LIBS are the libraries that libmetaflow depends on for execution

# -*- coding: utf-8 -*-
from silicoflow.libmetaflow.libmetaflow_test import MetaflowTest, ExpectationFailed, steps
...
class BasicTagTest(MetaflowTest):
    ...
    def step_all(self):
        ...
        from silicoflow.libmetaflow import get_namespace
        import os
    ...
    def check_results(self, flow, checker):
        import os
        from silicoflow.libmetaflow import namespace
        run = checker.get_run()
        if run is None:
        ...
        for tag in tags:
            ...
            for step in run:
                ...
                assert_equals([task.id for task in step],
